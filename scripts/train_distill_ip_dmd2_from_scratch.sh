accelerate launch src/train_distill_ip_dmd2_from_scratch.py \
	...
	--output_dir "/lustre/scratch/client/scratch/research/group/khoigroup/tungnt132/all_ckpt/train_distill_ip_dmd2_from_scratch_coca100k" \
    --task "coca100k"
