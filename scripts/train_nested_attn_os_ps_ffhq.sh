accelerate launch src/train_nested_attn_os_ps.py \
    --pretrained_model_name_or_path "runwayml/stable-diffusion-v1-5" \
    --pretrained_arcface_path "./all_backup_SP/ckpt/face/model_ir_se50.pth" \
	...
	--output_dir "./tmp_results/train_nested_attn_os_ps_ffhq" \
    --task "train_ffhq_nested_attn"
