accelerate launch src/train_ip_adapter_sb2_with_vsd.py \
	...
	--output_dir "/lustre/scratch/client/scratch/research/group/khoigroup/tungnt132/all_ckpt/train_ip_elpips_sb2_with_vsd_coca100k" \
    --task "coca100k"