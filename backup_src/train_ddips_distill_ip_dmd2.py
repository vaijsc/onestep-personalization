...
def main(args):
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(student_generator_with_ipa, teacher_with_ipa):
                # Get GT image latent
                with torch.no_grad():
                ...
                with torch.no_grad():
                    teacher_score_ip1 = teacher_with_ipa(noisy_samples, timesteps, prompt_embeds, image_embeds)
                    teacher_score_ip2 = teacher_with_ipa(noisy_samples, timesteps, prompt_null_embeds, null_image_embeds)
                    
                ddip_grad = teacher_score_ip1 - teacher_score_ip2
                ...
                accelerator.backward(loss_ddip + loss_diff)
