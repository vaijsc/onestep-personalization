...
class IPAdapter(torch.nn.Module):
    ...
    def load_from_checkpoint(self, ckpt_path: str):
        ...
        if self.name == "student":
            ## convert to nested attention dictionary key as pretrained weight
...
def inference(vae, tokenizer, text_encoder,
    ...
    student_generator_with_ipa.register_indices_to_alter(indices_to_alter)
...
def main(args):
    ...
    student_generator_with_ipa = get_ipa_generator(student_unet_gen_ip, image_encoder, "student", args.num_ip_tokens, attn_processor="nest")
    teacher_with_ipa = get_ipa_generator(teacher_unet, image_encoder, "teacher", attn_processor="ip")
    ...
    ref_image_column, text_column, idx_column = column_names
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(student_generator_with_ipa):
                ...
                ddip_grad = score - noise_add
                ddip_grad = torch.nan_to_num(ddip_grad)

                target = pred_img_latents - ddip_grad
